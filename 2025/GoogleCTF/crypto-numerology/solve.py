...
if __name__ == '__main__':
    ...
    x = rotl32(keystream_0, 20)
    y = (x - K4) & 4294967295
    ctr = rotl32(y, 16)

    pt = get_bytes(key_bytes=key, nonce_bytes=nonce_guess, initial_counter_int=ctr, data_bytes=flag_ct, current_constants_tuple=struct.zeros, rounds_to_execute=1)
